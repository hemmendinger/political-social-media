...
- Q-cnn-01 (2026-09-11): De-duplicates reposts. Of the four self-reposts posted and deleted on 2026-09-08 (117238301772357460, 117238326295991805, 117238345561593751, 117238414290995787), the archive kept only 117238345561593751; trumpstruth captured all four with removal times. Flag `cnn_dedup_risk` in `v_confidence`.
